...
class EventoCreateAddress extends Component { 	
    constructor(props) {
      super(props);
    }
    ...
    showDialog = () => {
      this.props.dispatch({
        type: 'SHOW_DIALOG_CONFIRM_EVENT',
        dialogVisible: true
        });
    };
      ...
      />
            <GooglePlacesAutocomplete
             ...
             <MapView style={{flex: 1}} initialRegion={{
                  latitude: this.props.store.createEventSelectedAddress.lat,
                  longitude: this.props.store.createEventSelectedAddress.lng,
                  latitudeDelta: 0.003,
              ...
              <MapView.Marker coordinate={{latitude: this.props.store.latitude,
                      ...
                      {this.props.store.eventos.map(marker => { 
                          return(
                            <MapView.Marker coordinate={{latitude: this.props.store.createEventSelectedAddress.lat,
                            longitude: this.props.store.createEventSelectedAddress.lng}}  title={marker.name}>
...
export default connect(store => ({store: store.application}))(EventoCreateAddress);